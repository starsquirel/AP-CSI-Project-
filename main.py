...
def RouletteWheel():
    # Chooses a random eliment in the Wheel
...
def main(Chips, Losses, Wins):
    ...
    while True:
        ...
        if Choice1 == "1":
            os.system('clear')
            Text("(1)black,(2)red,(3)high,(4)low, (5)even, (6)odd, (7)green, (8)specific number\n")
            ...
            if Bet <= Chips and Bet >= 1:
                Roll = RouletteWheel()
                #this prints the Roll and prints if it is black or red
                if Roll in Black:
                    print(BlackBG + f"\n{Roll} black" + Reset + "\n")
                if Roll in Red:
                    print(RedBG + f"\n{Roll} red" + Reset + "\n")
